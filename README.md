...
ninjadevsio-hubot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running ninjadevsio-hubot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start ninjadevsio-hubot locally by running:
